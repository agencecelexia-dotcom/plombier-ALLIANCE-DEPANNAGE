...
export const metadata: Metadata = generatePageMetadata({
  title: "Porte claquee a Nice : reagir et eviter les arnaques | Alliance Depannage",
  description: "Bloque devant votre porte a Nice ? Apprenez a choisir un serrurier de confiance, le cout reel d'une ouverture de porte et les arnaques a eviter absolument.",
    ...
    <>
      ...
      <SectionContainer>
        <div className="max-w-3xl mx-auto prose prose-slate">
          ...
          <h1>Porte claquee a Nice : comment reagir et eviter les arnaques</h1>
          <p className="lead">
            Vous rentrez chez vous et vous n'avez plus vos cles. Ou pire, votre cle est cassee dans la serrure. Dans ces moments de stress, le risque d'etre arnaque est reel. Voici ce qu'il faut savoir pour agir vite et bien a Nice.
          </p>
          ...
          <p>
            Les arnaques au serrurier sont malheureusement frequentes, notamment dans les grandes villes cotieres comme Nice. Voici les signaux d'alerte :
          </p>
          <ul>
          ...
          <h2>Combien coute une ouverture de porte a Nice ?</h2>
          <p>
          ...
          <p>
            Alliance Depannage est un artisan local niçois present depuis 2007. Sohaib et son equipe annoncent le tarif avant toute intervention, interviennent 24h/24 et remettent une facture detaillee. <strong>Aucune mauvaise surprise.</strong>
          </p>

          <div className="not-prose mt-8 p-6 bg-accent-500/10 rounded-xl">
            <p className="font-bold text-neutral-900 mb-2">Porte bloquee a Nice ?</p>
            <a
