...
export const metadata: Metadata = generatePageMetadata({
  title: `Chauffe-eau & Climatisation ${siteConfig.address.city} | Alliance Dépannage`,
  description: `Installation et remplacement de chauffe-eau à ${siteConfig.address.city}. Électrique, thermodynamique. Installation climatisation split. Dépannage urgent. Devis gratuit.`,
  path: "/chauffe-eau",
});
