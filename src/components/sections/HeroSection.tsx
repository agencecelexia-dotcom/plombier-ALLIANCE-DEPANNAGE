...
export function HeroSection({
  ...
  if (variant === "page") {
    return (
      <section className="relative min-h-[280px] md:min-h-[320px] flex items-center justify-center">
        <div className="absolute inset-0">
          <ImagePlaceholder
            prompt={imagePlaceholder.prompt}
            src={imagePlaceholder.src}
        ...
        <div className="relative z-20 w-full mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center py-16">
